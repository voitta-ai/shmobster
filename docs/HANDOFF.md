...
Current state: **v0.19.0 is cut; the live box is on v0.8.0 until someone
...
v0.14.0; #62 and #206 with v0.15.0; #213 with v0.16.0; #215 with v0.17.0; #219 with v0.18.0; #222 with v0.19.0. **Ten releases in a
row have added no config key** -- criterion 1 -- and #62 did not reset it after all: stdlib
