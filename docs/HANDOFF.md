...
Current state: **v0.10.0 is cut; the live box is still on v0.7.2 until someone
...
10 issues are open; three carry the `security` label -- #150, #186 and the
#123 tracker. #152 closed with v0.10.0.
