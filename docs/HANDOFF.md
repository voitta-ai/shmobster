...
Current state: **v0.14.0 is cut; the live box is on v0.8.0 until someone
...
adversarial reviews did. What remains is #62 and #191. #23 closed with v0.13.0; #140 and #190 with
v0.14.0. Five releases in a row have added no config key, which is 1.0.0
criterion 1 -- #62 will probably reset it. #1 closed as superseded by the README and this file.
